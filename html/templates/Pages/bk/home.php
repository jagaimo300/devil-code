...
<div class="swiper mySwiper">
    <div class="swiper-wrapper">
        <div class="swiper-slide"
            style="background-image: url('../img/sample_1.jpg')">
        ...
        <div class="swiper-slide"
            style="background-image: url('../img/sample_2.jpg')">
            <div class="text-wrapper ls-1">
                <h2 class="blog-ttl my-4">CakePHP</h2>
                <p class="blog-subTtl small">foooooooooooooooo</p>
            </div>
        ...
        <div class="swiper-slide"
            style="background-image: url('../img/sample_3.jpg')">
            <div class="text-wrapper ls-1">
                <h2 class="blog-ttl my-4">CakePHP</h2>
                <p class="blog-subTtl small">foooooooooooooooo</p>
            </div>
...
<section class="profile">
    <div class="container my-5">
        <div class="profile-inner row justify-content-center align-items-center text-left">
            <div class="ls-1 col-8 h-50 d-flex flex-column text-dark">
                <p>Author</p>
                <h2>Takahiro Ueda</h2>
                <p>Web Programmer</p>
                <p>Hello!! My name is Takahiro Ueda. I'm a Junior Web Developer based in Japan.
                <br>I love using my skills to make things better.
                <br>I like watching rugby, workout, watching Netflix.
                </p>
            </div>
            <div class="ls-1 col-4 h-50 d-flex flex-column bg-danger">
            </div>
        </div>
    </div>
</section>
