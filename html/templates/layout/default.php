        ...
        <div class="l-header__inner-upper">
           ...
           <svg class="logo-icon" version="1.0" xmlns="http://www.w3.org/2000/svg"
             width="256.000000pt" height="256.000000pt" viewBox="0 0 256.000000 256.000000"
              ...
              -67 249 -211 485 -392 643 -177 154 -373 250 -605 297 -117 24 -342 26 -461 4z"/>
              </g>
              </svg><span class="logo-name">devil code</span></a>
            <a class="serch-icon" href="/blogs#search"><svg viewBox="0 0 27 27" height="23" width="23"><path d="M11.56,3.43a8.26,8.26,0,0,0,0,16.52,8.18,8.18,0,0,0,5-1.72l4.7,4.7a1.1,1.1,0,0,0,1.56,0,1.09,1.09,0,0,0,0-1.55l0,0-4.7-4.7a8.18,8.18,0,0,0,1.72-5A8.28,8.28,0,0,0,11.56,3.43Zm0,2.2A6.06,6.06,0,1,1,5.5,11.69,6,6,0,0,1,11.56,5.63Z" fill="currentColor"></path></svg>
</a>
        </div>
        <div class="l-header__inner-downer">
            <nav class="c-headerNav" role="navigation" aria-label="main">
